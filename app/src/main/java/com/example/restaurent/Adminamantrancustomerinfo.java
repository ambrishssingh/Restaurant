...
public class Adminamantrancustomerinfo extends AppCompatActivity {

    private static final String PHP_SCRIPT_URL = "http://192.168.207.216/Run/selecta";
    private TableLayout tableLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.adminamantrancustomerinfo);
    ...
    private void addRowToTable(String name, String email, String mobileNumber, String date, String time, String nGuest, String place, String amount) {
        ...
        TableRow row = (TableRow) LayoutInflater.from(Adminamantrancustomerinfo.this).inflate(R.layout.table_row, null);
