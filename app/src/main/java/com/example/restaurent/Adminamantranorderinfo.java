...
public class Adminamantranorderinfo extends AppCompatActivity {

    private static final String PHP_SCRIPT_URL = "http://192.168.207.216/Run/selectao"; // Change the URL accordingly
    private TableLayout tableLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.adminamantranorderinfo);
    ...
    private void addRowToTable(String cName, String item, String value) {
        ...
        TableRow row = (TableRow) LayoutInflater.from(Adminamantranorderinfo.this).inflate(R.layout.order_row, null);
