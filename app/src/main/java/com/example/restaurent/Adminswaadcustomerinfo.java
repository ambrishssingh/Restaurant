...
public class Adminswaadcustomerinfo extends AppCompatActivity {

    private static final String PHP_SCRIPT_URL = "http://192.168.207.216/Run/selects";
    private TableLayout tableLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.adminswaadcustomerinfo);
    ...
    private void addRowToTable(String name, String email, String mobileNumber, String date, String time, String nGuest, String place, String amount) {
        ...
        TableRow row = (TableRow) LayoutInflater.from(Adminswaadcustomerinfo.this).inflate(R.layout.table_row, null);
